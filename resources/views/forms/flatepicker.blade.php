@extends('layouts.vertical', ['title' => 'Flatepicker', 'subTitle' => 'Form'])
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="overview">
                    Overview
                    <a class="btn btn-sm btn-outline-success rounded-2 float-end" href="https://flatpickr.js.org/#introduction" target="_blank">
                        Official Website
                    </a>
                </h5>
                <p class="text-muted mb-3">
                    flatpickr is a lightweight and powerful
                    datetime picker.
                </p>

                <h5 class="mt-2">Usage</h5>
                <p class="mb-0">
                    Flatpickr's CSS and Javascript files are
                    bundled in the
    ...
    <div class="col-xl-3">
        <div class="card docs-nav">
            <ul class="nav bg-transparent flex-column">
                ...
                <li class="nav-item">
                    <a href="#conjunction" class="nav-link">Selecting multiple dates -
                        Conjunction</a>
                </li>
                <li class="nav-item">
