@extends('layouts.vertical', ['title' => 'Range Slider', 'subTitle' => 'Form'])
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="overview">
                    Overview
                    <a class="btn btn-sm btn-outline-success rounded-2 float-end" href="https://github.com/leongersen/noUiSlider#readme" target="_blank">
                        Official Website
                    </a>
                </h5>
                <p class="text-muted mb-3">
                    noUiSlider is a lightweight JavaScript
                    range slider.
                </p>

                <h5 class="mt-2">Usage</h5>
                <p class="mb-0">
                    noUiSlider's CSS and Javascript files
                    are bundled in the
    ...
    <div class="col-xl-3">
        <div class="card docs-nav">
            <ul class="nav bg-transparent flex-column">
                ...
                <li class="nav-item">
                    <a href="#soft-limits " class="nav-link">Soft Limits
                    </a>
                </li>
            </ul>
        </div>
