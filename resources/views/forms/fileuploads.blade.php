@extends('layouts.vertical', ['title' => 'File Upload', 'subTitle' => 'Form'])
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="overview">
                    Overview
                    <a class="btn btn-sm btn-outline-success rounded-2 float-end" href="https://www.dropzone.dev/js" target="_blank">
                        Official Website
                    </a>
                </h5>
                <p class="text-muted mb-3">
                    Dropzone is a lightweight and powerful
                    datetime picker.
                </p>

                <h5 class="mt-2">Usage</h5>
                <p class="mb-0">
                    Dropzone's CSS and Javascript files are
                    bundled in the
