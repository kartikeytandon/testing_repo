@extends('layouts.vertical', ['title' => 'Validation', 'subTitle' => 'Form'])
    ...
    <div class="col-xl-9">
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    Depending on your browser and OS, you’ll
                    see a slightly different style of
                    feedback.
                </p>
                <div class="mb-3">
                    <form class="row g-3">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    ...
                    validation APIs in JavaScript. When
                    attempting to submit, you’ll see the
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    ...
                    validation, but in case you require
                    server-side validation, you can indicate
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    Validation styles are available for the
                    following form controls and components:
                </p>
                <ul>
                    <li>
                        ...
                        (including up to one
                        <code>.form-control</code> in input
                        groups)
                    </li>
                    <li>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    ...
                    in a styled tooltip. Be sure to have a
                    parent with
                    <code>position: relative</code> on it
                    for tooltip positioning. In the example
                    below, our column classes have this
                    already, but your project may require an
                    alternative setup.
                </p>
                <div class="mb-3">
                    <form class="row g-3 needs-validation" novalidate>
