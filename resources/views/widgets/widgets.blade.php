@extends('layouts.vertical', ['title' => 'Widgets', 'subTitle' => 'Reback'])
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="progress progress-sm">
                                            <div class="progress-bar bg-blue" role="progressbar" style="
                                                                        width: 21%;
                ...
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        <span class="text-danger">
                            <i class="bx bxs-down-arrow fs-12"></i>
                            0.3%</span>
                        <span class="text-muted ms-1 fs-12">Last Month</span>
                    </div>
                    <a href="#!" class="text-reset fw-semibold fs-12">View More</a>
            ...
            <div class="card-body p-0 pb-3">
                <div class="p-3" data-simplebar style="max-height: 386px">
                    ...
                    <div class="form-check form-todo py-1 my-2 ps-4">
                        ...
                        <label class="form-check-label" for="customCheck5">Investigate and analyze the
                            root cause of each bug</label>
                    </div>
                    <div class="form-check form-todo py-1 my-2 ps-4">
                        <input type="checkbox" class="form-check-input rounded-circle mt-0 fs-18" id="customCheck6" />
                        <label class="form-check-label" for="customCheck6">Develop and implement fixes for
                            the identified bugs</label>
                    </div>
                    <div class="form-check form-todo py-1 my-2 ps-4">
