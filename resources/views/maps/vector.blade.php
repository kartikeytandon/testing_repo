@extends('layouts.vertical', ['title' => 'Vector', 'subTitle' => 'Maps'])
...
<div class="row">
    <div class="col-xl-9">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="canada_vector_map">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="russia_vector_map">
                    Russia Vector Map<a class="anchor-link" href="#russia_vector_map">#</a>
                </h5>
                <p class="text-muted">
                    Give textual form controls like
                    <code>&lt;input&gt;</code>s and
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="iraq_vector_map">
                    Iraq Vector Map<a class="anchor-link" href="#iraq_vector_map">#</a>
                </h5>
                <p class="text-muted">
                    Give textual form controls like
                    <code>&lt;input&gt;</code>s and
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="spain_vector_map">
                    Spain Vector Map<a class="anchor-link" href="#spain_vector_map">#</a>
                </h5>
                <p class="text-muted">
                    Give textual form controls like
                    <code>&lt;input&gt;</code>s and
    ...
    <div class="col-xl-3">
        <div class="card docs-nav">
            <ul class="nav bg-transparent flex-column">
                ...
                <li class="nav-item">
                    <a href="#russia_vector_map" class="nav-link">Russia Vector Map</a>
                </li>
                <li class="nav-item">
                    <a href="#iraq_vector_map" class="nav-link">Iraq Vector Map</a>
                </li>
                <li class="nav-item">
                    <a href="#spain_vector_map" class="nav-link">Spain Vector Map</a>
                </li>
            </ul>
        </div>
    </div>
...
@section('script')
@vite(['resources/js/components/maps-vector.js', 'resources/js/components/maps-canada.js', 'resources/js/components/maps-iraq.js', 'resources/js/components/maps-russia.js', 'resources/js/components/maps-spain.js'])
@endsection