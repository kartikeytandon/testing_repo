@extends('layouts.vertical', ['title' => 'Sweet Alerts', 'subTitle' => 'Advanced UI'])
    ...
    <div class="col-xl-9">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="overview">
                    Overview
                    <a class="btn btn-sm btn-outline-success rounded-2 float-end" href="https://sweetalert2.github.io/" target="_blank">
                        Official Website
                    </a>
                </h5>
                <p class="text-muted mb-3">
                    A beautiful, responsive, customizable,
                    accessible (WAI-ARIA) replacement for
                    JavaScript's popup boxes
                </p>

                <h5 class="mt-2">Usage</h5>
                <p class="mb-0">
                    Sweetalert2's CSS and Javascript files
                    are bundled in the
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-3">
                    <button type="button" class="btn btn-primary" id="sweetalert-basic">
                        Click me
                    </button>
                </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-3">
                    <button type="button" class="btn btn-primary" id="sweetalert-title">
                        Click me
                    </button>
                </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="hstack gap-2 mb-3">
                    <button type="button" class="btn btn-success" id="sweetalert-success">
                        Success
                    </button>
                    <button type="button" class="btn btn-warning" id="sweetalert-warning">
                        Warning
                    </button>
                    <button type="button" class="btn btn-info" id="sweetalert-info">
                        Info
                    </button>
                    <button type="button" class="btn btn-danger" id="sweetalert-error">
                        Error
                    </button>
                </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-3">
                    <button type="button" class="btn btn-primary" id="sweetalert-longcontent">
                        Click me
                    </button>
                </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-3">
                    <button type="button" class="btn btn-primary" id="sweetalert-params">
                        Click me
                    </button>
                </div>
