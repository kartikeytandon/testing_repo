@extends('layouts.vertical', ['title' => 'Toastify', 'subTitle' => 'Advanced UI'])
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="overview">
                    Overview
                    <a class="btn btn-sm btn-outline-success rounded-2 float-end" href="https://apvarun.github.io/toastify-js/" target="_blank">
                        Official Website
                    </a>
                </h5>
                ...
                <p class="mb-0">
                    Toastify-js's Javascript files are
                    bundled in the
    ...
    <div class="col-xl-3">
        <div class="card docs-nav">
            <ul class="nav bg-transparent flex-column">
                ...
                <li class="nav-item">
                    <a href="#rater" class="nav-link">Offset, Close Button & Duration
                        Example</a>
                </li>
            </ul>
        </div>
