@extends('layouts.vertical', ['title' => 'Ratings', 'subTitle' => 'Advanced UI'])
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="overview">
                    Overview
                    <a class="btn btn-sm btn-outline-success rounded-2 float-end" href="https://fredolss.github.io/rater-js/" target="_blank">
                        Official Website
                    </a>
                </h5>
                <p class="text-muted mb-3">
                    Rater js is the best star rater for the
                    browser. No dependencies. Unlimited
                    number of stars
                </p>

                <h5 class="mt-2">Usage</h5>
                <p class="mb-0">
                    Rater js's CSS and Javascript files are
                    bundled in the
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    <div dir="ltr">
                        ...
                        <button id="raterreset-button" class="btn btn-light btn-sm ms-2">
                            Reset
                        </button>
                    </div>
                </div>
