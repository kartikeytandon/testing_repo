@extends('layouts.vertical', ['title' => 'Create Product', 'subTitle' => 'Ecommerce'])

@section('css')
    @vite(['node_modules/quill/dist/quill.bubble.css', 'node_modules/quill/dist/quill.snow.css', 'node_modules/choices.js/public/assets/styles/choices.min.css','node_modules/dropzone/dist/dropzone.css'])
@endsection
                ...
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs border-0">
                        <li class="nav-item" data-target-form="#generalDetailForm">
                            <a href="#generalDetail" data-bs-toggle="tab" data-toggle="tab"
                ...
                <div class="card-body">
                    <div class="tab-content pt-0">
                        <div class="tab-pane show active" id="generalDetail">
                            <form id="generalDetailForm" method="post" action="#">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <div id="snow-editor" style="
                                                                ...
                                                                ">
                                                <h5>
                                                <span class="ql-size-large">Describe
                                                    Your
                                                    Product
                                                    Description...</span>
                                                </h5>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="productSummary" class="form-label">Product
                                                Summary</label>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control select2" data-toggle="select2">
                                                ...
                                                <optgroup label="Shopping">
                                                    <option value="shopping1">
                                                        Shopping
                                                        1
                                                    </option>
                                                    <option value="shopping2">
                                                        Shopping
                                                        2
                                                    </option>
                                                    <option value="shopping3">
                                                        Shopping
                                                        3
                                                    </option>
                                                    <option value="shopping4">
                                                        Shopping
                                                        4
                                                    </option>
                                                </optgroup>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="radio" type="radio" id="onlineStatus"
                                               value="Online" checked/>
                                        <label class="form-check-label" for="onlineStatus">Online</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="radio" type="radio" id="offlineStatus"
                                               value="Offline"/>
                                        <label class="form-check-label" for="offlineStatus">Offline</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="radio" type="radio" id="draftStatus"
                                               value="Draft"/>
                        ...
                        <div class="tab-pane" id="productImages">
                            ...
                            <form action="/" method="post" class="dropzone" id="productImagesForm"
