@extends('layouts.vertical', ['title' => 'Contact', 'subTitle' => 'Apps'])

@section('content')

<div class="row row-cols-1 row-cols-md-2 row-cols-xl-4 gx-3">
    <div class="col">
        <div class="card">
            <div class="card-body">
                <div class="text-center">
                    <img src="/images/users/avatar-1.jpg" alt="avatar-1" class="img-fluid avatar-xl img-thumbnail rounded-circle avatar-border" />
                    <h4 class="mt-3 fs-18">
                        <a href="javascript:void(0);" class="text-dark">Anna M. Hines</a>
                    </h4>
                    ...
                    <br />
                    <a href="{{ route('second', ['pages', 'profile'])}}" class="btn btn-sm btn-outline-primary mt-3">View Profile</a>
                </div>
            </div>
            <!-- end card body -->
        </div>
    ...
    <div class="col">
        <div class="card">
            <div class="card-body">
                <div class="text-center">
                    <img src="/images/users/avatar-2.jpg" alt="avatar-2" class="img-fluid avatar-xl img-thumbnail rounded-circle avatar-border" />
                    <h4 class="mt-3 fs-18">
                        <a href="javascript:void(0);" class="text-dark">Candice F. Gilmore</a>
                    </h4>
    ...
    <div class="col">
        <div class="card">
            <div class="card-body">
                <div class="text-center">
                    <img src="/images/users/avatar-3.jpg" alt="avatar-3" class="img-fluid avatar-xl img-thumbnail rounded-circle avatar-border" />
                    <h4 class="mt-3 fs-18">
                        <a href="javascript:void(0);" class="text-dark">Vanessa R. Davis</a>
                    </h4>
    ...
    <div class="col">
        <div class="card">
            <div class="card-body">
                <div class="text-center">
                    <img src="/images/users/avatar-4.jpg" alt="avatar-4" class="img-fluid avatar-xl img-thumbnail rounded-circle avatar-border" />
                    <h4 class="mt-3 fs-18">
                        <a href="javascript:void(0);" class="text-dark">Judith H. Fritsche</a>
                    </h4>
    ...
    <div class="col">
        <div class="card">
            <div class="card-body">
                <div class="text-center">
                    <img src="/images/users/avatar-5.jpg" alt="avatar-5" class="img-fluid avatar-xl img-thumbnail rounded-circle avatar-border" />
                    <h4 class="mt-3 fs-18">
                        <a href="javascript:void(0);" class="text-dark">Peter T. Smith</a>
                    </h4>
    ...
    <div class="col">
        <div class="card">
            <div class="card-body">
                <div class="text-center">
                    <img src="/images/users/avatar-6.jpg" alt="avatar-6" class="img-fluid avatar-xl img-thumbnail rounded-circle avatar-border" />
                    <h4 class="mt-3 fs-18">
                        <a href="javascript:void(0);" class="text-dark">Emmanuel J. Delcid</a>
                    </h4>
    ...
    <div class="col">
        <div class="card">
            <div class="card-body">
                <div class="text-center">
                    <img src="/images/users/avatar-7.jpg" alt="avatar-7" class="img-fluid avatar-xl img-thumbnail rounded-circle avatar-border" />
                    <h4 class="mt-3 fs-18">
                        <a href="javascript:void(0);" class="text-dark">William J. Cook</a>
                    </h4>
    ...
    <div class="col">
        <div class="card">
            <div class="card-body">
                <div class="text-center">
                    <img src="/images/users/avatar-8.jpg" alt="avatar-8" class="img-fluid avatar-xl img-thumbnail rounded-circle avatar-border" />
                    <h4 class="mt-3 fs-18">
                        <a href="javascript:void(0);" class="text-dark">Martin R. Peters</a>
                    </h4>
    ...
    <div class="col">
        <div class="card">
            <div class="card-body">
                <div class="text-center">
                    <img src="/images/users/avatar-9.jpg" alt="avatar-9" class="img-fluid avatar-xl img-thumbnail rounded-circle avatar-border" />
                    <h4 class="mt-3 fs-18">
                        <a href="javascript:void(0);" class="text-dark">Paul M. Schubert</a>
                    </h4>
    ...
    <div class="col">
        <div class="card">
            <div class="card-body">
                <div class="text-center">
                    <img src="/images/users/avatar-10.jpg" alt="avatar-10" class="img-fluid avatar-xl img-thumbnail rounded-circle avatar-border" />
                    <h4 class="mt-3 fs-18">
                        <a href="javascript:void(0);" class="text-dark">Janet J. Champine</a>
                    </h4>
