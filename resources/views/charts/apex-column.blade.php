@extends('layouts.vertical', ['title' => 'Apex Column Charts', 'subTitle' => 'Charts'])
...
<div class="row">
    <div class="col-xl-9">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-3anchor" id="datalabels">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title anchor" id="stacked">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title anchor" id="full-stacked">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title anchor" id="markers">
                    Column with Markers
                </h4>
                <div dir="ltr">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title anchor" id="group">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title anchor" id="rotate-labels">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title anchor" id="negative-value">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title anchor" id="range">
                    Range Column Chart
                </h4>
                <div dir="ltr">
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex mb-3">
                    <h4 class="card-title anchor flex-grow-1" id="dynamic">
    ...
    <div class="col-xl-3">
        <div class="card docs-nav">
            <ul class="nav bg-transparent flex-column">
                ...
                <li class="nav-item">
                    <a href="#negative-value" class="nav-link">Column Chart with negative
                        values</a>
                </li>
                <li class="nav-item">
