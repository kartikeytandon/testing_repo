                            ...
                            <div class="card d-inline-block">
                                <div class="card-body">
                                    <h5 class="mt-0 fs-16">
                                        Completed UX design
                                        project for our
                                        client<span class="badge bg-secondary ms-1 align-items-center">important</span>
                                    </h5>
                                    <p class="text-muted mb-0">
                                        Dolorum provident
                                        rerum aut hic quasi
                                        placeat iure tempora
                                        laudantium ipsa ad
                                        debitis unde?
                                    </p>
                                </div>
                        ...
                        <div class="overflow-hidden">
                            <div class="card d-inline-block">
                                <div class="card-body">
                                    <h5 class="mt-0 fs-16">
                                        We released new
                                        version of our theme
                                        Reback.
                                    </h5>
                                    <p class="text-muted mb-0">
                                        3 new photo Uploaded
        ...
        <ul class="list-unstyled left-timeline">
            <li class="left-timeline-list">
                <div class="card d-inline-block">
                    <div class="card-body">
                        <h5 class="mt-0 fs-16">
                            Completed UX design project for
                            our client<span class="badge bg-secondary ms-1 align-items-center">important</span>
                        </h5>
                        <p class="text-muted mb-0">
                ...
                <div class="card d-inline-block">
                    <div class="card-body">
                        ...
                        <p class="text-muted mb-0">
                            ...
                            Iusto, optio, dolorum
                            <b>John deon</b> provident rerum
                            aut hic quasi placeat iure
                            tempora laudantium
                        </p>
                    </div>
                </div>
            ...
            <li class="left-timeline-list">
                <div class="card d-inline-block">
                    <div class="card-body">
                        <h5 class="mt-0 fs-16">
                            We released new version of our
                            theme Reback.
                        </h5>
                        <p class="text-muted mb-0">
                            3 new photo Uploaded on facebook
                            fan page
                        </p>
                    </div>
                </div>
        ...
        <ul class="list-unstyled left-timeline">
            <li class="left-timeline-list">
                <div class="card d-inline-block">
                    <div class="card-body">
                        <h5 class="mt-0 fs-16">
                            We have archieved 25k sales in
                            our themes
                        </h5>
                        <p class="text-muted mb-0">
                            Dolorum provident rerum aut hic
            ...
            <li class="left-timeline-list">
                <div class="card d-inline-block">
                    <div class="card-body">
                        ...
                        <p class="text-muted mb-0">
                            Outdoor visit at California
                            State Route 85 with John Boltana
                            & Harry Piterson regarding to
                            setup a new show room.
                        </p>
                    </div>
                </div>
            </li>
            ...
            <li class="left-timeline-list">
                <div class="card d-inline-block">
                    <div class="card-body">
                        ...
                        <p class="text-muted mb-0">
                            Alex Smith is a Senior Software
                            (Full Stack) engineer with a
                            deep passion for building
                            usable, functional & pretty web
                            applications.
                        </p>
                    </div>
                </div>
