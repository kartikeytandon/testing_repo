@extends('layouts.vertical', ['title' => 'Progress', 'subTitle' => 'Base UI'])
    ...
    <div class="col-xl-9">
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    A progress bar can be used to show a
                    user how far along he/she is in a
                    process.
                </p>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="backgrounds-color">
                    Backgrounds Color
                    <a class="anchor-link" href="#backgrounds-color">#</a>
                </h5>
                <p class="text-muted">
                    Use background utility classes to change
                    the appearance of individual progress
                    bars.
                </p>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="progress-bar">
                    ...
                    <a class="anchor-link" href="#progress-bar">#</a>
                </h5>
                <p class="text-muted">
                    Add
                    <code>.progress-bar-striped</code> to
                    any <code>.progress-bar</code> to apply
                    a stripe via CSS gradient over the
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="height">
                    Height
                    <a class="anchor-link" href="#height">#</a>
                </h5>
                <p class="text-muted">
                    We only set a height value on the
                    <code>.progress</code>, so if you change
                    that value the inner
                    <code>.progress-bar</code> will
