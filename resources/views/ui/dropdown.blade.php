@extends('layouts.vertical', ['title' => 'Dropdown', 'subTitle' => 'Base UI'])
    ...
    <div class="col-xl-9">
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    Any single <code>.btn</code> can be
                    turned into a dropdown toggle with some
                    markup changes. Here&apos;s how you can
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="single-button-variant">
                    ...
                    <a class="anchor-link" href="#single-button-variant">#</a>
                </h5>
                <p class="text-muted">
                    Any single <code>.btn</code> can be
                    turned into a dropdown toggle with some
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="split-button">
                    ...
                    <a class="anchor-link" href="#split-button">#</a>
                </h5>
                <p class="text-muted">
                    Similarly, create split button dropdowns
                    with virtually the same markup as single
                    button dropdowns, but with the addition
                    of
                    <code>.dropdown-toggle-split</code> for
                    proper spacing around the dropdown
                    caret.
                </p>
                <div class="d-flex flex-wrap gap-2 mb-3">
                    <div class="btn-group">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="dark-dropdown">
                    Dark Dropdowns
                    <a class="anchor-link" href="#dark-dropdown">#</a>
                </h5>
                <p class="text-muted">
                    Opt into darker dropdowns to match a
                    dark navbar or custom style by adding
                    <code>.dropdown-menu-dark</code> onto an
                    existing <code>.dropdown-menu</code>. No
                    changes are required to the dropdown
                    items.
                </p>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="direction">
                    Dropdown Direction
                    <a class="anchor-link" href="#direction">#</a>
                </h5>
                <p class="text-muted">
                    Trigger dropdown menus above elements by
                    adding <code>.dropup</code>, dropdown
                    menus at the left of the elements by
                    adding <code>.dropstart</code> or
                    dropdown menus at the right of the
                    elements by adding
                    <code>.dropend</code>.
                </p>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="menu-items">
                    Dropdown Menu Items
                    <a class="anchor-link" href="#menu-items">#</a>
                </h5>
                <p class="text-muted">
                    Add <code>.active</code> to items in the
                    dropdown to
                    <strong>style them as active</strong>.
                    To convey the active state to assistive
                    technologies, use the
                    <code>aria-current</code> attribute —
                    using the <code>page</code> value for
                    the current page, or
                    <code>true</code> for the current item
                    in a set.
                </p>
                <p class="text-muted">
                    Add <code>.disabled</code> to items in
                    the dropdown to
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="dropdown-options">
                    Dropdown options
                    <a class="anchor-link" href="#dropdown-options">#</a>
                </h5>
                <p class="text-muted">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="auto-close-behavior">
                    Auto close behavior
                    <a class="anchor-link" href="#auto-close-behavior">#</a>
                </h5>
                <p class="text-muted">
                    By default, the dropdown menu is closed
                    when clicking inside or outside the
                    dropdown menu. You can use the
                    <code>autoClose</code> option to change
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="menu-content">
                    Menu Content
                    <a class="anchor-link" href="#menu-content">#</a>
                </h5>
                <p>
                    Add a header to label sections of
                    actions in any dropdown menu.
                </p>
                <p>
                    Separate groups of related menu items
                    with a divider.
                </p>
                <p>
                    Place any freeform text within a
                    dropdown menu with text and use spacing
                    utilities. Note that you’ll likely need
                    additional sizing styles to constrain
                    the menu width.
                </p>
                <p>
                    Put a form within a dropdown menu, or
                    make it into a dropdown menu, and use
                    margin or padding utilities to give it
                    the negative space you require.
                </p>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-lg p-3">
                            <p>
                                ...
                                free-flowing within the
                                dropdown menu.
                            </p>
                            <p class="mb-0">
                                And this is more example
                                text.
                            </p>
                        </div>
                    </div>
    ...
    <div class="col-xl-3">
        <div class="card docs-nav">
            <ul class="nav bg-transparent flex-column">
                ...
                <li class="nav-item">
                    <a href="#single-button-variant" class="nav-link">Single Button Variant Dropdowns
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#split-button" class="nav-link">Split Button Dropdowns
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="#direction" class="nav-link">Dropdown Direction
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#menu-items" class="nav-link">Dropdown Menu Items
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#dropdown-options" class="nav-link">Dropdown Options
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#auto-close-behavior" class="nav-link">Auto Close Behavior
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#menu-content" class="nav-link">Menu content
                    </a>
                </li>
            </ul>
        </div>
