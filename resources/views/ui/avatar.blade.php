@extends('layouts.vertical', ['title' => 'Avatars', 'subTitle' => 'Base UI'])
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted font-14 mb-3">
                    Create and group avatars of different
                    sizes and shapes with the css classes.
                    Using Bootstrap's naming convention, you
                    can control size of avatar including
                    standard avatar, or scale it up to
                    different sizes.
                </p>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted font-14 mb-4">
                    ...
                    <code>.rounded-circle</code> in
                    <code>&lt;img&gt;</code> element creates
                    the rounded avatar.
                </p>
