@extends('layouts.vertical', ['title' => 'Accordion', 'subTitle' => 'Base UI'])
    ...
    <div class="col-xl-9">
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    Using the card component, you can extend
                    the default collapse behavior to create
                    an accordion. To properly achieve the
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="flush">
                    Flush Accordion
                    <a class="anchor-link" href="#flush">#</a>
                </h5>
                <p class="text-muted">
                    Add <code>.accordion-flush</code> to
                    remove the default
                    <code>background-color</code>, some
                    borders, and some rounded corners to
                    render accordions edge-to-edge with
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="always-open">
                    ...
                    <a class="anchor-link" href="#always-open">#</a>
                </h5>
                <p class="text-muted">
                    Omit the
                    <code>data-bs-parent</code> attribute on
                    each <code>.accordion-collapse</code> to
                    make accordion items stay open when
