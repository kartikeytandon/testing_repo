@extends('layouts.vertical', ['title' => 'Popovers', 'subTitle' => 'Base UI'])
    ...
    <div class="col-xl-9">
            ...
            <div class="card-body">
                <div>
                    ...
                    <p class="text-muted">
                        ...
                        set via
                        <code>data-bs-title</code> and body
                        content is set via
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="popover-directions">
                    Popover Directions
                    <a class="anchor-link" href="#popover-directions">#</a>
                </h5>
                <p class="text-muted">
                    Four options are available: top, right,
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="dismiss">
                    ...
                    <a class="anchor-link" href="#dismiss">#</a>
                </h5>
                <p class="text-muted">
                    Use the <code>focus</code> trigger to
                    dismiss popovers on the user’s next
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="hover">
                    Hover
                    <a class="anchor-link" href="#hover">#</a>
                </h5>
                <p class="text-muted">
                    Use the
                    <code>data-bs-trigger="hover"</code>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="custom-popovers">
                    Custom Popovers
                    <a class="anchor-link" href="#custom-popovers">#</a>
                </h5>
                <p class="text-muted">
                    ou can customize the appearance of
                    popovers using CSS variables. We set a
                    custom class with
                    <code>data-bs-custom-class="primary-popover"</code>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    Elements with the
                    <code>disabled</code> attribute aren’t
                    interactive, meaning users cannot hover
                    or click them to trigger a popover (or
                    tooltip). As a workaround, you’ll want
                    to trigger the popover from a wrapper
                    <code>&lt;div&gt;</code> or
                    <code>&lt;span&gt;</code> and override
                    the <code>pointer-events</code> on the
                    disabled element.
                </p>
