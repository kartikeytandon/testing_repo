@extends('layouts.vertical', ['title' => 'Spinners', 'subTitle' => 'Base UI'])
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="color_spinners">
                    Color Spinners
                    <a class="anchor-link" href="#color_spinners">#</a>
                </h5>
                <p class="text-muted">
                    You can use any of our text color
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="growing_spinners">
                    Growing Spinners
                    <a class="anchor-link" href="#growing_spinners">#</a>
                </h5>
                <p class="text-muted">
                    If you don’t fancy a border spinner,
                    switch to the grow spinner. While it
                    doesn’t technically spin, it does
                    repeatedly grow!
                </p>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="color_growing">
                    ...
                    <a class="anchor-link" href="#color_growing">#</a>
                </h5>
                <p class="text-muted">
                    You can use any of our text color
                    utilities on the standard spinner.
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="alignment">
                    Alignment
                    <a class="anchor-link" href="#alignment">#</a>
                </h5>
                <p class="text-muted">
                    Use flexbox utilities, float utilities,
                    or text alignment utilities to place
                    spinners exactly where you need them in
                    any situation.
                </p>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    ...
                    <code>.spinner-border.sm-**</code> to
                ...
                <div class="d-flex align-items-center justify-content-between bg-light border-top border-bottom py-1 px-3">
                    ...
                    <button class="btn btn-sm btn-outline-success btn-copy-clipboard" data-clipboard-action="copy" data-clipboard-target="#size">
                        Copy
                    </button>
                </div>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="placement">
                    Placement
                    <a class="anchor-link" href="#placement">#</a>
                </h5>
                <p class="text-muted">
                    Use <code>flexbox utilities</code>,
                    <code>float utilities</code>, or
                    <code>text alignment</code> utilities to
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="button_spinner">
                    Buttons Spinner
                    <a class="anchor-link" href="#button_spinner">#</a>
                </h5>
                <p class="text-muted">
                    Use spinners within buttons to indicate
                    an action is currently processing or
                    taking place. You may also swap the text
                    out of the spinner element and utilize
