@extends('layouts.vertical', ['title' => 'Collapse', 'subTitle' => 'Base UI'])
    ...
    <div class="col-xl-9">
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    Click the buttons below to show and hide
                    another element via class changes:
                </p>
                <ul>
                    <li>
                    ...
                    <li>
                        <code>.collapsing</code> is applied
                        during transitions
                    </li>
                    <li>
                        <code>.collapse.show</code> shows
                        content
                    </li>
                </ul>
                <p class="text-muted">
                    ...
                    with the <code>href</code> attribute
                    (and a <code>role="button"</code>). In
                    both cases, the
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="horizontal">
                    Horizontal
                    <a class="anchor-link" href="#horizontal">#</a>
                </h5>
                <p class="text-muted">
                    The collapse plugin also supports
                    horizontal collapsing. Add the
                    <code>.collapse-horizontal</code>
                    modifier class to transition the
                    <code>width</code> instead of
                    <code>height</code> and set a
                    <code>width</code> on the immediate
                    ...
                    <div style="min-height: 135px">
                        <div class="collapse collapse-horizontal" id="collapseWidthExample">
                            <div class="card card-body mb-0" style="width: 300px">
                                ...
                                content for a horizontal
                                collapse. It's hidden by
                                default and shown when
                                triggered.
                            </div>
                        </div>
                    </div>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="multiple-targets">
                    Multiple Targets
                    <a class="anchor-link" href="#multiple-targets">#</a>
                </h5>
                <p class="text-muted">
                    A <code>&lt;button&gt;</code> or
                    <code>&lt;a&gt;</code> can show and hide
