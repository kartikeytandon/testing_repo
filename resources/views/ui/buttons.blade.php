@extends('layouts.vertical', ['title' => 'Buttons', 'subTitle' => 'Base UI'])
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="rounded">
                    Rounded Buttons
                    <a class="anchor-link" href="#rounded">#</a>
                </h5>
                <p class="text-muted">
                    Add <code>.rounded-pill</code> to
                    default button to get rounded
                    corners.
                </p>
                <div class="mb-3">
                    <div class="button-list">
                        ...
                        <button type="button" class="btn btn-pink rounded-pill">
                            Pink
                        </button>
                        <button type="button" class="btn btn-orange rounded-pill">
                            Orange
                        </button>
                        <button type="button" class="btn btn-light rounded-pill">
                            Light
                        </button>
                        <button type="button" class="btn btn-link rounded-pill">
                            Link
                        </button>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="outline">
                    Outline Buttons
                    <a class="anchor-link" href="#outline">#</a>
                </h5>
                <p class="text-muted">
                    Use a classes
                    <code>.btn-outline-**</code> to
                    quickly create a bordered buttons.
                </p>
                <div class="mb-3">
                    <div class="button-list">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="outline-rounded">
                    ...
                    <a class="anchor-link" href="#outline-rounded">#</a>
                </h5>
                <p class="text-muted">
                    Use a classes
                    <code>.btn-outline-**</code> to
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="soft">
                    Soft Buttons
                    <a class="anchor-link" href="#soft">#</a>
                </h5>
                <p class="text-muted">
                    Use a classes
                    <code>.btn-soft-**</code> to quickly
                    create buttons with soft background.
                </p>
                <div class="mb-3">
                    <div class="button-list">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="soft-rounded">
                    ...
                    <a class="anchor-link" href="#soft-rounded">#</a>
                </h5>
                <p class="text-muted">
                    Use a classes
                    <code>.rounded-pill**</code> with
                    <code>.btn-soft-**</code> to quickly
                    create a Outline Soft buttons.
                </p>
                <div class="mb-3">
                    <div class="button-list">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="width">
                    Button Width
                    <a class="anchor-link" href="#width">#</a>
                </h5>
                <p class="text-muted">
                    Create buttons with minimum width by
                    adding add <code>.width-xs</code>,
                    <code>.width-sm</code>,
                    <code>.width-md</code>,
                ...
                <div class="mb-3">
                    <div class="button-list">
                        <button type="button" class="btn btn-primary width-xl">
                            Extra Large
                        </button>
                        <button type="button" class="btn btn-secondary width-lg">
                            Large
                        </button>
                        <button type="button" class="btn btn-success width-md">
                            Middle
                        </button>
                        <button type="button" class="btn btn-info width-sm">
                            Small
                        </button>
                        <button type="button" class="btn btn-warning width-xs">
                            Xs
                        </button>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="sizes">
                    Button Sizes
                    <a class="anchor-link" href="#sizes">#</a>
                </h5>
                <p class="text-muted">
                    Add <code>.btn-lg</code>,
                    <code>.btn-sm</code> for additional
                    sizes.
                </p>
                <div class="mb-3">
                    <div class="button-list">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="disabled">
                    Disabled Button
                    <a class="anchor-link" href="#disabled">#</a>
                </h5>
                <p class="text-muted">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="icon">
                    Icon Button
                    <a class="anchor-link" href="#icon">#</a>
                </h5>
                <p class="text-muted">
                    Icon only Button.
                </p>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="group">
                    Button Group
                    <a class="anchor-link" href="#group">#</a>
                </h5>
                <p class="text-muted">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="block">
                    Block Button
                    <a class="anchor-link" href="#block">#</a>
                </h5>
                <p class="text-muted">
                    Create block level buttons by adding
                    class <code>.d-grid</code> to parent
                    div.
                </p>
                <div class="mb-3">
            ...
            <div class="">
                <div class="">
                    <ul class="nav bg-transparent flex-column">
                        ...
                        <li class="nav-item">
                            <a href="#rounded " class="nav-link">Rounded Buttons
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#outline" class="nav-link">Outline Buttons
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#outline-rounded" class="nav-link">Outline Rounded Buttons
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#soft" class="nav-link">Soft Buttons
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#soft-rounded " class="nav-link">Soft Rounded Buttons
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#width " class="nav-link">Button Width
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#sizes " class="nav-link">Button Sizes
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#disabled " class="nav-link">Disabled Button
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#icon " class="nav-link">Icon Button
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#group " class="nav-link">Button Group
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#block" class="nav-link">Block Button
                            </a>
                        </li>
                    </ul>
                </div>
