@extends('layouts.vertical', ['title' => 'Badge', 'subTitle' => 'Base UI'])
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="heading">
                    Heading
                    <a class="anchor-link" href="#heading">#</a>
                </h5>
                <p class="text-muted">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="default_pill_badges">
                    Default & Pill Badges
                    <a class="anchor-link" href="#default_pill_badges">#</a>
                </h5>
                <p class="text-muted">
                    Use our background utility classes to
                    quickly change the appearance of a
                    badge. And use the
                    <code>.rounded-pill</code> class to make
                    badges more rounded.
                </p>
                <div class="mb-3">
                    <!-- Default Badges -->
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="outline_badges">
                    ...
                    <a class="anchor-link" href="#outline_badges">#</a>
                </h5>
                <p class="text-muted">
                    Using the
                    <code>.badge-outline-**</code> to
                    quickly create a bordered badges.
                </p>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="soft_badges">
                    ...
                    <a class="anchor-link" href="#soft_badges">#</a>
                </h5>
                <p class="text-muted">
                    Using the
                    <code>.badge-soft-**</code> modifier
                    class, you can have more soften
                    variation.
                </p>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="component_badges">
                    Buttons & Position
                    <a class="anchor-link" href="#component_badges">#</a>
                </h5>
                <p class="text-muted">
                ...
                <div class="mb-3">
                    <div class="mb-2">
                        ...
                        <button type="button" class="btn btn-soft-primary me-1 mb-1">
                            Notifications
                            <span class="badge bg-primary ms-1">11</span>
                        </button>
                        <a href="javascript:void(0);" class="btn me-1 mb-1">
                            Notifications
                            <span class="badge bg-primary ms-1">90+</span>
                        </a>
                    </div>
