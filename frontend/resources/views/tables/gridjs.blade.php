@extends('layouts.vertical', ['title' => 'GridJs', 'subTitle' => 'Table'])
    ...
    <div class="col-xl-10">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title anchor mb-1" id="overview">
                    Overview
                    <a class="btn btn-sm btn-outline-success rounded-2 float-end" href="https://gridjs.io" target="_blank">
                        Official Website
                    </a>
                </h5>
                <p class="sub-header">
                    Grid.js is a Free and open-source
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    Grid.js supports global search on all
                    rows and columns. Set
                    <code>search: true</code> to enable the
                    search plugin:
                </p>
                <div class="py-3">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    ...
                    <code>sort: true</code> to your config:
                </p>
                <div class="py-3">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    Grid.js renders a loading bar
                    automatically while it waits for the
                    data to be fetched. Here we are using an
                    async function to demonstrate this
                    behaviour (e.g. an async function can be
                    a XHR call to a server backend)
                </p>
                <div class="py-3">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    Add <code>hidden: true</code> to the
