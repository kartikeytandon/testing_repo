@extends('layouts.vertical', ['title' => 'Product Details', 'subTitle' => 'Ecommerce'])
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="ps-xl-3 mt-3 mt-xl-0">
                            ...
                            <h4 class="mb-3">
                                (8 GB/256 GB SSD/Mac OS Big
                                Sur) MGN63HN/A (13.3 inch,
                                Space Grey, 1.29 kg)
                            </h4>
                            ...
                            <p class="mb-3">
                                <a href="javascript:void(0);" class="text-muted">( 36 Customer Reviews
                                    )</a>
                            </p>
                            ...
                            <h4 class="mb-3">
                                Price :
                                <span class="text-muted me-2"><del>$999 USD</del></span>
                                <b>$899 USD</b>
                            </h4>
                            <h4>
                                <span class="badge badge-soft-success mb-3">Instock</span>
                            </h4>
                            ...
                            <div class="mb-3">
                                ...
                                <p class="text-muted mb-1">
                                    <i class="bx bx-check-circle text-primary me-2"></i>Quad LED Backlit IPS
                                    Display (227 PPI, 400
                                    nits Brightness, Wide
                                    Colour (P3), True Tone
                                    Technology)
                                </p>
                                <p class="text-muted mb-1">
                                    <i class="bx bx-check-circle text-primary me-2"></i>Built-in Speakers
                                </p>
                                <p class="text-muted mb-1">
                                    <i class="bx bx-check-circle text-primary me-2"></i>Three-mic Array with
                                    Directional Beamforming
                                </p>
                                <p class="text-muted mb-1">
                                    <i class="bx bx-check-circle text-primary me-2"></i>Stereo Speakers, Wide
                                    Stereo Sound, Support
                                    for Dolby Atmos Playback
                                </p>
                                <p class="text-muted mb-1">
                                    <i class="bx bx-check-circle text-primary me-2"></i>49.9 WHr Li-polymer
                                    Battery
                                </p>
                                <p class="text-muted mb-1">
                                    <i class="bx bx-check-circle text-primary me-2"></i>Backlit Magic Keyboard
                                </p>
                            </div>

                            <div>
                                <button type="button" class="btn btn-danger me-2">
                                    <i class="bx bx-heart fs-18"></i>
                                </button>
                                <button type="button" class="btn btn-primary">
                                    <i class="bx bx-cart fs-18 me-2"></i>Add to cart
                                </button>
                            </div>
                        </div>
                    </div>
