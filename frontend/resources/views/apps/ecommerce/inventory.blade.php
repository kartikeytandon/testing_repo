@extends('layouts.vertical', ['title' => 'Inventory', 'subTitle' => 'Ecommerce'])
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex flex-wrap align-items-center gap-2">
                            ...
                            <a href="{{ route('third', ['apps', 'ecommerce', 'product-add'])}}" class="btn btn-primary d-inline-flex align-items-center ms-md-auto"><i class="bx bx-plus me-1"></i>Add Product</a>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table text-nowrap mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge badge-soft-warning">Return</span>
                                </td>
                                <td>WareHouse 3</td>
                                <td>125</td>
                                <td>4512</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge badge-soft-danger">Damaged</span>
                                </td>
                                <td>WareHouse 1</td>
                                <td>4523</td>
                                <td>1241</td>
