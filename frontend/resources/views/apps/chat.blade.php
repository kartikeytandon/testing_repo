...
<head>
    @include('layouts.partials/title-meta', ['title' => 'Chat'])
                        ...
                        <div class="card position-relative overflow-hidden">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide avatar-sm">
                                        <div class="chat-user-status-box">
                                            <span><img src="/images/users/avatar-1.jpg" alt="avatar-1"
                                                       class="img-fluid avatar-sm rounded-circle avatar-border"/></span>
                                        </div>
                                    </div>
                                    <div class="swiper-slide avatar-sm">
                                        <div class="chat-user-status-box">
                                            <span><img src="/images/users/avatar-2.jpg" alt="avatar-2"
                                                       class="img-fluid avatar-sm rounded-circle avatar-border"/></span>
                                        </div>
                                    </div>
                                    <div class="swiper-slide avatar-sm">
                                        <div class="chat-user-status-box">
                                            <span><img src="/images/users/avatar-3.jpg" alt="avatar-3"
                                                       class="img-fluid avatar-sm rounded-circle avatar-border"/></span>
                                        </div>
                                    </div>
                                    <div class="swiper-slide avatar-sm">
                                        <div class="chat-user-status-box">
                                            <span><img src="/images/users/avatar-4.jpg" alt="avatar-4"
                                                       class="img-fluid avatar-sm rounded-circle avatar-border"/></span>
                                        </div>
                                    </div>
                                    <div class="swiper-slide avatar-sm">
                                        <div class="chat-user-status-box">
                                            <span><img src="/images/users/avatar-5.jpg" alt="avatar-5"
                                                       class="img-fluid avatar-sm rounded-circle avatar-border"/></span>
                                        </div>
                                    </div>
                                    <div class="swiper-slide avatar-sm">
                                        <div class="chat-user-status-box">
                                            <span><img src="/images/users/avatar-6.jpg" alt="avatar-6"
                                                       class="img-fluid avatar-sm rounded-circle avatar-border"/></span>
                                        </div>
                                    </div>
                                    <div class="swiper-slide avatar-sm">
                                        <div class="chat-user-status-box">
                                            <span><img src="/images/users/avatar-7.jpg" alt="avatar-7"
                                                       class="img-fluid avatar-sm rounded-circle avatar-border"/></span>
                                        </div>
                                    </div>
                                    <div class="swiper-slide avatar-sm">
                                        <div class="chat-user-status-box">
                                            <span><img src="/images/users/avatar-8.jpg" alt="avatar-8"
                                                       class="img-fluid avatar-sm rounded-circle avatar-border"/></span>
                                        </div>
                                    </div>
                                    <div class="swiper-slide avatar-sm">
                                        <div class="chat-user-status-box">
                                            <span><img src="/images/users/avatar-9.jpg" alt="avatar-9"
                                                       class="img-fluid avatar-sm rounded-circle avatar-border"/></span>
                                        </div>
                                    </div>
                                    <div class="swiper-slide avatar-sm">
                                        <div class="chat-user-status-box">
                                            <span><img src="/images/users/avatar-10.jpg" alt="avatar-10"
                                                       class="img-fluid avatar-sm rounded-circle avatar-border"/></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane show active" id="chat-list">
                                    <div class="px-3 mb-3 chat-setting-height" data-simplebar>
                                        <a href="javascript:void(0);" class="text-body">
                                            <div class="d-flex align-items-center p-2 chat-item">
                                                <div class="flex-shrink-0 position-relative">
                                                    <img src="/images/users/avatar-2.jpg" class="me-2 rounded-circle"
                                                         height="36" alt="avatar-2"/>
                                                </div>
                                        ...
                                        <a href="javascript:void(0);" class="text-body">
                                            <div class="d-flex align-items-center p-2 chat-item">
                                                <div class="flex-shrink-0 position-relative">
                                                    <img src="/images/users/avatar-3.jpg" class="me-2 rounded-circle"
                                                         height="36" alt="avatar-3"/>
                                                </div>
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <h5 class="my-0">
                                        ...
                                        <a href="javascript:void(0);" class="text-body">
                                            <div class="d-flex align-items-center chat-item active p-2 rounded-1">
                                                <div class="flex-shrink-0 position-relative">
                                                    <img src="/images/users/avatar-4.jpg" class="me-2 rounded-circle"
                                                         height="36" alt="avatar-4"/>
                                                </div>
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <h5 class="my-0">
                                        ...
                                        <a href="javascript:void(0);" class="text-body">
                                            <div class="d-flex align-items-center p-2 chat-item">
                                                <div class="flex-shrink-0 position-relative">
                                                    <img src="/images/users/avatar-5.jpg" class="me-2 rounded-circle"
                                                         height="36" alt="avatar-5"/>
                                                </div>
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <h5 class="my-0">
                                        ...
                                        <a href="javascript:void(0);" class="text-body">
                                            <div class="d-flex align-items-center p-2 chat-item">
                                                <div class="flex-shrink-0 position-relative">
                                                    <img src="/images/users/avatar-6.jpg" class="me-2 rounded-circle"
                                                         height="36" alt="avatar-6"/>
                                                </div>
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <h5 class="my-0">
                                                        <span class="float-end text-muted fs-13">Yesterday</span>
                                        ...
                                        <a href="javascript:void(0);" class="text-body">
                                            <div class="d-flex align-items-center p-2 chat-item">
                                                <div class="flex-shrink-0 position-relative">
                                                    <img src="/images/users/avatar-7.jpg" class="me-2 rounded-circle"
                                                         height="36" alt="avatar-7"/>
                                                </div>
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <h5 class="my-0">
                                                        <span class="float-end text-muted fs-13">Yesterday</span>
                                        ...
                                        <a href="javascript:void(0);" class="text-body">
                                            <div class="d-flex align-items-center p-2 chat-item">
                                                <div class="flex-shrink-0 position-relative">
                                                    <img src="/images/users/avatar-8.jpg" class="me-2 rounded-circle"
                                                         height="36" alt="avatar-8"/>
                                                </div>
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <h5 class="my-0">
                                        ...
                                        <a href="javascript:void(0);" class="text-body">
                                            <div class="d-flex align-items-center p-2 chat-item">
                                                <div class="flex-shrink-0 position-relative">
                                                    <img src="/images/users/avatar-9.jpg" class="me-2 rounded-circle"
                                                         height="36" alt="avatar-9"/>
                                                </div>
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <h5 class="my-0">
                                                        <span class="float-end text-muted fs-13">7/8/21</span>
                                        ...
                                        <a href="javascript:void(0);" class="text-body">
                                            <div class="d-flex align-items-center p-2 chat-item">
                                                <div class="flex-shrink-0 position-relative">
                                                    <img src="/images/users/avatar-10.jpg" class="me-2 rounded-circle"
                                                         height="36" alt="avatar-10"/>
                                                </div>
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <h5 class="my-0">
                                                        <span class="float-end text-muted fs-13">7/8/21</span>
                                ...
                                <div class="tab-pane" id="group-list">
                                    <div class="px-3 mb-3 chat-setting-height" data-simplebar>
                                        ...
                                        <div class="chat-item d-flex mb-3 align-items-center position-relative">
                                            <a href="javascript:void(0);"
                                               class="me-2 stretched-link rounded bg-soft-primary text-primary avatar d-flex align-items-center justify-content-center fs-18">G</a>
                                        ...
                                        <div class="chat-item d-flex mb-3 align-items-center position-relative">
                                            <a href="javascript:void(0);"
                                               class="me-2 stretched-link rounded bg-soft-primary text-primary avatar d-flex align-items-center justify-content-center fs-18">C</a>
                                            <div class="flex-grow-1 ps-1 overflow-hidden">
                                                <div class="float-end">
                                                    <span class="badge badge-outline-danger">+33</span>
                                                </div>
                                                <h5 class="fs-14 m-0">
                                                    #Company
                                                </h5>
                                        ...
                                        <div class="chat-item d-flex mb-3 align-items-center position-relative">
                                            <a href="javascript:void(0);"
                                               class="me-2 stretched-link rounded bg-soft-primary text-primary avatar d-flex align-items-center justify-content-center fs-18">L</a>
                                            <div class="flex-grow-1 ps-1 overflow-hidden">
                                                <div class="float-end">
                                                    <span class="badge badge-outline-danger">+17</span>
                                                </div>
                                                <h5 class="fs-14 m-0">
                                                    #Life Suckers
                                                </h5>
                                        ...
                                        <div class="chat-item d-flex mb-3 align-items-center position-relative">
                                            <a href="javascript:void(0);"
                                               class="me-2 stretched-link rounded bg-soft-primary text-primary avatar d-flex align-items-center justify-content-center fs-18">D</a>
                                            <div class="flex-grow-1 ps-1 overflow-hidden">
                                                <h5 class="fs-14 m-0">
                                                    #Drama Club
                                                </h5>
                                        ...
                                        <div class="chat-item d-flex mb-3 align-items-center position-relative">
                                            <a href="javascript:void(0);"
                                               class="me-2 stretched-link rounded bg-soft-primary text-primary avatar d-flex align-items-center justify-content-center fs-18">U</a>
                                            <div class="flex-grow-1 ps-1 overflow-hidden">
                                                <h5 class="fs-14 m-0">
                                                    #Unknown Friends
                                                </h5>
                                        ...
                                        <div class="chat-item d-flex mb-3 align-items-center position-relative">
                                            <a href="javascript:void(0);"
                                               class="me-2 stretched-link rounded bg-soft-primary text-primary avatar d-flex align-items-center justify-content-center fs-18">F</a>
                                            <div class="flex-grow-1 ps-1 overflow-hidden">
                                                <div class="float-end">
                                                    <span class="badge badge-outline-danger">+65</span>
                                                </div>
                                                <h5 class="fs-14 m-0">
                                                    #Family Ties
                                                </h5>
                                        ...
                                        <div class="chat-item d-flex mb-3 align-items-center position-relative">
                                            <a href="javascript:void(0);"
                                               class="me-2 stretched-link rounded bg-soft-primary text-primary avatar d-flex align-items-center justify-content-center fs-18">2</a>
                                            <div class="flex-grow-1 ps-1 overflow-hidden">
                                                <h5 class="fs-14 m-0">
                                                    #2Good4U
                                                </h5>
                                ...
                                <div class="tab-pane" id="contact-list">
                                    <div class="px-3 mb-3 chat-setting-height" data-simplebar>
                                        ...
                                        <div class="chat-item d-flex align-items-center position-relative py-2">
                                            <a href="#!" class="stretched-link"><img src="/images/users/avatar-2.jpg"
                                                                                     class="me-2 rounded-circle"
                                                                                     height="36" alt="avatar-2"/></a>
                                            <div class="flex-grow-1">
                                                <h5 class="my-0 fs-14">
                                                    Gaston Lapierre
                                                </h5>
                                        ...
                                        <div class="chat-item d-flex align-items-center position-relative py-2">
                                            <a href="#!" class="stretched-link"><img src="/images/users/avatar-3.jpg"
                                                                                     class="me-2 rounded-circle"
                                                                                     height="36" alt="avatar-2"/></a>
                                            <div class="flex-grow-1">
                                                <h5 class="my-0 fs-14">
                                                ...
                                                <p class="mt-1 mb-0 text-muted">
                                                        <span class="w-75">** no status
                                                            **</span>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="chat-item d-flex align-items-center position-relative py-2">
                                            <a href="#!" class="stretched-link"><img src="/images/users/avatar-4.jpg"
                                                                                     class="me-2 rounded-circle"
                                                                                     height="36" alt="avatar-2"/></a>
                                            <div class="flex-grow-1">
                                                <h5 class="my-0 fs-14">
                                                ...
                                                <p class="mt-1 mb-0 text-muted">
                                                        <span class="w-75">|| Karma
                                                            ||</span>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="chat-item d-flex align-items-center position-relative py-2">
                                            <a href="#!" class="stretched-link"><img src="/images/users/avatar-5.jpg"
                                                                                     class="me-2 rounded-circle"
                                                                                     height="36" alt="avatar-2"/></a>
                                            <div class="flex-grow-1">
                                                <h5 class="my-0 fs-14">
                                                ...
                                                <p class="mt-1 mb-0 text-muted">
                                                        <span class="w-75">Hey there! I am
                                                            using
                                                            Chat.</span>
                                                </p>
                                            </div>
                                        ...
                                        <div class="chat-item d-flex align-items-center position-relative py-2">
                                            <a href="#!" class="stretched-link"><img src="/images/users/avatar-6.jpg"
                                                                                     class="me-2 rounded-circle"
                                                                                     height="36" alt="avatar-2"/></a>
                                            <div class="flex-grow-1">
                                                <h5 class="my-0 fs-14">
                                                ...
                                                <p class="mt-1 mb-0 text-muted">
                                                    <span class="w-75">TM</span>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="chat-item d-flex align-items-center position-relative py-2">
                                            <a href="#!" class="stretched-link"><img src="/images/users/avatar-7.jpg"
                                                                                     class="me-2 rounded-circle"
                                                                                     height="36" alt="avatar-2"/></a>
                                            <div class="flex-grow-1">
                                                <h5 class="my-0 fs-14">
                                                ...
                                                <p class="mt-1 mb-0 text-muted">
                                                    <span class="w-75">Available</span>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="chat-item d-flex align-items-center position-relative py-2">
                                            <a href="#!" class="stretched-link"><img src="/images/users/avatar-8.jpg"
                                                                                     class="me-2 rounded-circle"
                                                                                     height="36" alt="avatar-2"/></a>
                                            <div class="flex-grow-1">
                                                <h5 class="my-0 fs-14">
                            ...
                            <div class="offcanvas offcanvas-start position-absolute shadow w-100" data-bs-scroll="true"
                                ...
                                <div class="offcanvas-header">
                                    <h5 class="offcanvas-title text-truncate w-50" id="user-settingLabel">
                                        Profile
                                    </h5>
                                ...
                                <div class="offcanvas-body p-0 h-100" data-simplebar>
                                    <h4 class="page-title p-3 my-0">
                                        Setting
                                    </h4>

                                    <div class="d-flex align-items-center px-3 pb-3 border-bottom">
                                        <img src="/images/users/avatar-1.jpg" class="me-2 rounded-circle" height="36"
                                             alt="avatar-1"/>
                                        <div class="flex-grow-1">
                                            <div class="float-end">
                                                    ...
                                                    <button class="accordion-button px-0 pt-0 collapsed" type="button"
                                                            ...
                                                            <span class="d-flex align-items-center">
                                                                ...
                                                                <span class="flex-grow-1">
                                                                    ...
                                                                    <span class="mt-1 mb-0 text-muted w-75">Privacy,
                                                                        security,
                                                                        change
                                                                        number</span>
                                                                </span>
                                                ...
                                                <div id="collapseAccount" class="accordion-collapse collapse"
                                                    ...
                                                    <div class="accordion-body pb-0">
                                                        <ul class="list-unstyled mb-0">
                                                            ...
                                                            <li class="mb-2">
                                                                <a href="javascript:void(0);"><i
                                                                        class="bx bx-check-Reback fs-18 me-2"></i>Security</a>
                                                            </li>
                                                            <li class="mb-2">
                                                                <a href="javascript:void(0);"><i
                                                            ...
                                                            <li>
                                                                <a href="javascript:void(0);"><i
                                                                        class="bx bx-trash fs-18 me-2"></i>Delete
                                                                    my
                                                                    account</a>
                                                            </li>
                                                        </ul>
                                                    ...
                                                    <button class="accordion-button px-0 collapsed" type="button"
                                                            ...
                                                            <span class="d-flex align-items-center">
                                                                ...
                                                                <span class="flex-grow-1">
                                                                    ...
                                                                    <span class="mt-1 mb-0 text-muted w-75">Theme,
                                                                        wallpapers,
                                                                        chat
                                                                        history</span>
                                                                </span>
                                                    ...
                                                    <div class="accordion-body pb-0">
                                                        ...
                                                        <ul class="list-unstyled">
                                                            <li class="mb-2 ms-2">
                                                                ...
                                                                <a href="javascript:void(0);">Media
                                                                    Visibility</a>
                                                                <p class="mb-0 text-muted fs-12">
                                                                    Show
                                                                    Newly
                                                            ...
                                                            <li class="mb-2 ms-2">
                                                                ...
                                                                <a href="javascript:void(0);">Enter
                                                                    is
                                                                    send</a>
                                                                <p class="mb-0 text-muted fs-12">
                                                                    Enter
                                                    ...
                                                    <button class="accordion-button px-0 collapsed" type="button"
                                                            ...
                                                            <span class="d-flex align-items-center">
                                                                ...
                                                                <span class="flex-grow-1">
                                                                    ...
                                                                    <span class="mt-1 mb-0 text-muted w-75">Message,
                                                                        group,
                                                                        call
                                                                        tones</span>
                                                                </span>
                                                    ...
                                                    <div class="accordion-body pb-0">
                                                        <ul class="list-unstyled mb-0">
                                                            <li class="mb-2">
                                                                ...
                                                                <a href="javascript:void(0);">Conversation
                                                                    Tones</a>
                                                                <p class="mb-0 text-muted fs-12">
                                                                    Play
                                                                    sound
                                                        ...
                                                        <ul class="list-unstyled mb-0">
                                                            <li class="mb-2">
                                                                <a href="javascript:void(0);">Notification
                                                                    Tone</a>
                                                                <p class="mb-0 text-muted fs-12">
                                                                    Default
                                                                    ringtone
                                                ...
                                                <h5 class="accordion-header my-0" id="headingStorage">
                                                    <button class="accordion-button px-0 collapsed" type="button"
                                                            ...
                                                            <span class="d-flex align-items-center">
                                                                ...
                                                                <span class="flex-grow-1">
                                                                    <span class="fs-14 h5 mt-0 mb-1 d-block">Storage
                                                                        and
                                                                        data</span>
                                                                    <span class="mt-1 mb-0 text-muted w-75">Network
                                                                        usage,
                                                                        auto
                                                                        download</span>
                                                                </span>
                                                    ...
                                                    <div class="accordion-body pb-0">
                                                        <ul class="list-unstyled mb-0">
                                                            <li class="d-flex">
                                                                ...
                                                                <div class="flex-grow-1">
                                                                    <a href="javascript:void(0);">Manage
                                                                        storage</a>
                                                                    <p class="mb-0 text-muted fs-12">
                                                                        2.4
                                                                        GB
                                                        ...
                                                        <ul class="list-unstyled mb-0">
                                                            <li class="d-flex">
                                                                ...
                                                                <div class="flex-grow-1">
                                                                    <a href="javascript:void(0);">Network
                                                                        usage</a>
                                                                    <p class="mb-0 text-muted fs-12">
                                                                        7.2
                                                                        GB
                                                        ...
                                                        <ul class="list-unstyled mb-0 mt-2">
                                                            <li class="ms-2">
                                                                <a href="javascript:void(0);">Photo
                                                                    upload
                                                                    quality</a>
                                                                <p class="mb-0 text-muted fs-12">
                                                                    Auto
                                                    ...
                                                    <button class="accordion-button px-0 collapsed" type="button"
                                                            ...
                                                            <span class="d-flex align-items-center">
                                                                ...
                                                                <span class="flex-grow-1">
                                                                    ...
                                                                    <span class="mt-1 mb-0 text-muted w-75">Help
                                                                        center,
                                                                        contact
                                                                        us,
                                                                        privacy
                ...
                <div class="col-xxl-9">
                    <div class="card position-relative overflow-hidden">
                            ...
                            <ul class="chat-conversation-list p-3 chatbox-height">
                                    ...
                                    <div class="chat-conversation-text">
                                        <div class="d-flex">
                                            ...
                                            <div class="chat-conversation-actions dropdown dropend">
                                                <a href="javascript: void(0);" class="ps-1" data-bs-toggle="dropdown"
                                        ...
                                        <p class="text-muted fs-12 mb-0 mt-1 ms-2">
                                            8:20 am
                                        </p>
                                    </div>
                                </li>
                                    ...
                                    <div class="chat-conversation-text ms-0">
                                        <div class="d-flex justify-content-end">
                                            <div class="chat-conversation-actions dropdown dropstart">
                                                <a href="javascript: void(0);" class="pe-1" data-bs-toggle="dropdown"
                                                   aria-expanded="false"><i
                                                        class="bx bx-dots-vertical-rounded fs-18"></i></a>
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="javascript: void(0);">
                                        ...
                                        <p class="text-muted fs-12 mb-0 mt-1">
                                            8:20 am<i class="bx bx-check-double ms-1 text-primary"></i>
                                        </p>
                                    </div>
                                </li>
                                <li class="clearfix">
                                ...
                                <li class="clearfix odd">
                                    <div class="chat-conversation-text ms-0">
                                        ...
                                        <p class="text-muted fs-12 mb-0 mt-1">
                                            8:25 am<i class="bx bx-check-double ms-1 text-primary"></i>
                                        </p>
                                    </div>
                                </li>
                                <li class="clearfix">
                                    <div class="chat-conversation-text ms-0">
                                        <div class="d-flex">
                                            <div class="chat-ctext-wrap">
                                                <a href="javascript:void(0);">
                                                    <img src="/images/small/img-1.jpg" alt="attachment" style="
                                                                    height: 84px;
                                                                " class="img-thumbnail me-1"/>
                                                </a>
                                                <a href="javascript:void(0);">
                                                    <img src="/images/small/img-2.jpg" alt="attachment" style="
                                                                    height: 84px;
                                                                " class="img-thumbnail me-1"/>
                                                </a>
                                                <a href="javascript:void(0);">
                                                    <img src="/images/small/img-3.jpg" alt="attachment" style="
                                                                    height: 84px;
                                                                " class="img-thumbnail me-1"/>
                                                </a>
                                            </div>
                                ...
                                <li class="clearfix odd">
                                    ...
                                    <div class="chat-conversation-text ms-0">
                                        ...
                                        <p class="text-muted fs-12 mb-0 mt-1">
                                            8:27 am<i class="bx bx-check-double ms-1 text-primary"></i>
                                        </p>
                                    </div>
                                </li>
                                <li class="clearfix">
                        ...
                        <div class="offcanvas offcanvas-end position-absolute shadow border-start" data-bs-scroll="true"
                            ...
                            <div class="offcanvas-header">
                                <h5 class="offcanvas-title text-truncate w-50" id="user-profileLabel">
                                    Profile
                                </h5>
                                <button type="button" class="btn-close" data-bs-dismiss="offcanvas"
                                        aria-label="Close"></button>
                            ...
                            <div class="offcanvas-body p-0 h-100" data-simplebar>
                                <div class="p-3">
                                    <div class="text-center">
                                        <img src="/images/users/avatar-4.jpg" alt="shreyu"
                                    ...
                                    <div class="row gx-1 pt-2">
                                        <div class="col-4">
                                            <a href="javascript:void(0);">
                                                <img src="/images/small/img-1.jpg" alt="img-1"
                                                     class="img-fluid rounded"/>
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="javascript:void(0);">
                                                <img src="/images/small/img-2.jpg" alt="img-2"
                                                     class="img-fluid rounded"/>
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <div class="position-relative overflow-hidden rounded">
                                                <a href="javascript:void(0);">
                                                    <img src="/images/small/img-3.jpg" alt="img-3"
                                                         class="img-fluid rounded"/>
...
@vite(['resources/js/app.js', 'resources/js/pages/app-chat.js'])
