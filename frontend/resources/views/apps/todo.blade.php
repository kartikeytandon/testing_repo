@extends('layouts.vertical', ['title' => 'Todo', 'subTitle' => 'Apps'])
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="form-check form-todo ps-4">
                                            ...
                                            <label class="form-check-label" for="customCheck1">Review
                                                system logs
                                                for any
                                                reported
                                                errors</label>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="form-check form-todo ps-4">
                                            ...
                                            <label class="form-check-label" for="customCheck2">Conduct
                                                user testing
                                                to identify
                                                potential
                                                bugs</label>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="form-check form-todo ps-4">
                                            ...
                                            <label class="form-check-label" for="customCheck3">Gather
                                                feedback
                                                from
                                                stakeholders
                                                regarding
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="form-check form-todo ps-4">
                                            ...
                                            <label class="form-check-label" for="customCheck4">Prioritize
                                                bugs based
                                                on severity
                                                and impact
                                            </label>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="form-check form-todo ps-4">
                                            ...
                                            <label class="form-check-label" for="customCheck5">Investigate
                                                and analyze
                                                the root
                                                cause of
                                                each
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="form-check form-todo ps-4">
                                            ...
                                            <label class="form-check-label" for="customCheck7">Complete
                                                any
                                                recurring
                                                tasks</label>
                                        </div>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="form-check form-todo ps-4">
                                            ...
                                            <label class="form-check-label" for="customCheck8">Check
                                                emails and
                                                respond</label>
                                        </div>
                                    </div>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="form-check form-todo ps-4">
                                            ...
                                            <label class="form-check-label" for="customCheck9">Review
                                                schedule for
                                                the
                                                day</label>
                                        </div>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="form-check form-todo ps-4">
                                            ...
                                            <label class="form-check-label" for="customCheck10">Daily
                                                stand-up
                                                meeting</label>
                                        </div>
                                    </div>
