@extends('layouts.vertical', ['title' => 'Form Select', 'subTitle' => 'Form'])
    ...
    <div class="col-xl-9">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="overview">
                    Overview
                    <a class="btn btn-sm btn-outline-success rounded-2 float-end" href="https://github.com/Choices-js/Choices" target="_blank">
                        Official Website
                    </a>
                </h5>
                <p class="text-muted mb-3">
                    Choices.js is a A vanilla, lightweight,
                    configurable select box/text input
                    plugin. Similar to Select2 and Selectize
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    Set <code>data-choices</code> attribute
                    to set a default single select.
                </p>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    Set
                    <code>data-choices
                        data-choices-sorting-false</code>
                    attribute.
                </p>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb-3">
                            <label for="choices-text-remove-button" class="form-label text-muted">Set limit values with
                                remove button</label>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="unique-values">
                    Text inputs in Unique values only, no
                    pasting
                ...
                <p class="text-muted">
                    Set
                    <code>data-choices
                        data-choices-text-unique-true</code>
                    attribute.
                </p>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb-3">
                            <label for="choices-text-unique-values" class="form-label text-muted">Unique values only, no
                                pasting</label>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    Set
                    <code>data-choices
                        data-choices-text-disabled-true</code>
                    attribute.
                </p>
    ...
    <div class="col-xl-3">
        <div class="card docs-nav">
            <ul class="nav bg-transparent flex-column">
                ...
                <li class="nav-item">
                    <a href="#basic" class="nav-link">Basic Example
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#options-group" class="nav-link">Option Groups Example
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#options-add-no-search" class="nav-link">Options added via config with no
                        search
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#options-add-no-sorting" class="nav-link">Options added via config with no
                        sorting
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#multiple-select" class="nav-link">Multiple select input
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#multiple-select-remove" class="nav-link">Multiple select With remove button
                        input
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#multiple-groups" class="nav-link">Multiple select With Option groups
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#text-input" class="nav-link">Text inputs
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#unique-values" class="nav-link">Text inputs in Unique values only,
                        no pasting
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#disabled" class="nav-link">Disabled Text Inputs
                    </a>
                </li>
            </ul>
        </div>
