@extends('layouts.vertical', ['title' => 'Clipboard', 'subTitle' => 'Form'])
    ...
    <div class="col-xl-9">
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted mb-3">
                    Choices.js is a lightweight and powerful
                    datetime picker.
                </p>
                ...
                <p class="mb-0">
                    <span class="fw-medium">Find the JS file for the following
                        chart at:</span>
                    <code>
                        ../src/assets/js/components/form-clipboard.js</code>
                </p>
            </div>
            <!-- end card-body -->
        </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    The value you include on this attribute
                    needs to match another's element
                    selector.
                </p>
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            <div class="input-group">
                                ...
                                <button class="btn btn-primary btn-copy-clipboard" data-clipboard-target="#clipboard_example">
                                    Copy
                                </button>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="d-flex gap-2 align-items-start mb-3">
                            <textarea id="clipboard_cut" class="form-control" cols="62" rows="6">
Mussum ipsum cacilds, vidis litro abertis. Consetis adipiscings elitis. Pra lá , depois divoltis porris, paradis. Paisis, filhis, espiritis santis. Mé faiz elementum girarzis, nisi eros vermeio, in elementis mé pra quem é amistosis quis leo. Manduma pindureta quium dia nois paga.</textarea>
                            <button class="btn btn-primary" data-clipboard-action="cut" data-clipboard-target="#clipboard_cut">
                                Cut
                            </button>
                        </div>
                    </div>
