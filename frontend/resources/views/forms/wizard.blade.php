@extends('layouts.vertical', ['title' => 'Wizard', 'subTitle' => 'Form'])
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title anchor" id="basic-wizard">
                        Horizontal Wizard<a class="anchor-link" href="#horizontal-wizard">#</a>
                    </h5>
                </div>
                <!-- end card-header -->
                <div class="card-body">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    <label for="basicConfirmPassword" class="form-label">Confirm
                                                        Password</label>
                                                    <input id="basicConfirmPassword" type="text" class="form-control"
                                            ...
                                            <div class="col-12">
                                                <div class="avatar-lg mb-3">
                                                    <div
                                                        ...
                                                        <img id="preview" src="/images/users/dummy-avatar.jpg"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="number" id="basicMnumber" class="form-control"
                    ...
                    <div class="highlight">
                        <div class="highlight-toolbar">
                            <ul class="nav nav-pills bg-transparent">
                                <li class="nav-item">
                                    <a href="#horizontal-wiazrd-html" data-bs-toggle="tab" aria-expanded="false"
                                       class="nav-link active">
                                        <span class="fs-12 text-uppercase">html</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="#horizontal-wiazrd-javascript" data-bs-toggle="tab" aria-expanded="true"
                                       class="nav-link">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title anchor" id="basic-wizard">
                        Vertical Wizard<a class="anchor-link" href="#vertical-wizard">#</a>
                    </h5>
                </div>
                <!-- end card-header -->
                <div class="card-body">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                <label class="form-label" for="basicFname2">First
                                                                    Name</label>
                                                                <input type="text" id="basicFname2" class="form-control"
                                                                       placeholder="Chris"/>
                                                            </div>
                                                        </div>
                                                        <!-- end col -->
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                <label class="form-label" for="basicLname2">Last
                                                                    Name</label>
                                                                <input type="text" id="basicLname2" class="form-control"
                                                                       placeholder="Keller"/>
                                                            </div>
                                                        </div>
                                                        <!-- end col -->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input id="basicGoogleLink2" type="text" class="form-control"
                                                               placeholder="Google Link"/>
                                                    </div>
                                                </div>
                                                <!-- end col -->
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input id="basicInstagramLink3" type="text" class="form-control"
                                                               placeholder="Instagram Link"/>
                                                    </div>
                                                </div>
                                                <!-- end col -->
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex gap-2">
                                                ...
                                                <div class="next">
                                                    <a href="javascript:void(0);" class="btn btn-primary">
                                                        Next
                                                        Step<i class="bx bx-right-arrow-alt ms-2"></i>
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="last">
                    ...
                    <div class="highlight">
                        <div class="highlight-toolbar">
                            <ul class="nav nav-pills bg-transparent">
                                <li class="nav-item">
                                    <a href="#vertical-wiazrd-html" data-bs-toggle="tab" aria-expanded="false"
                                       class="nav-link active">
                                        <span class="fs-12 text-uppercase">html</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="#vertical-wiazrd-javascript" data-bs-toggle="tab" aria-expanded="true"
                                       class="nav-link">
                                        <span class="fs-12 text-uppercase">javascript</span>
                                    </a>
                                </li>
