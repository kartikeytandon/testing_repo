@extends('layouts.vertical', ['title' => 'Editors', 'subTitle' => 'Form'])
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="overview">
                    Overview
                    <a class="btn btn-sm btn-outline-success rounded-2 float-end" href="https://quilljs.com/" target="_blank">
                        Official Website
                    </a>
                </h5>
                <p class="text-muted mb-3">
                    Quilljs is a lightweight and powerful
                    datetime picker.
                </p>

                <h5 class="mt-2">Usage</h5>
                <p class="mb-0">
                    Quilljs's CSS and Javascript files are
                    bundled in the
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    Use <code>snow-editor</code> id to set
                    snow editor.
                </p>
                <div class="mb-3">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    Use <code>bubble-editor</code> id to set
                    bubble editor.
                </p>
                <div class="mb-3">
                    <!-- Bubble Editors -->
