                    ...
                    <table class="table table-borderless table-hover table-nowrap align-middle mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    20 Apr,24
                                    <small class="text-muted">10:31:23 am</small>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <img src="/images/users/avatar-2.jpg" alt="" class="avatar-xs rounded-circle me-1" />
                                ...
                                <td>
                                    18 Apr,24
                                    <small class="text-muted">06:22:09 pm</small>
                                </td>
                                <td>
                                    <span class="badge bg-info-subtle text-info p-1">Cancelled</span>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    16 Apr,24
                                    <small class="text-muted">05:09:58 pm</small>
                                </td>
                                <td>
                                    <span class="badge bg-success-subtle text-success p-1">Success</span>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <img src="/images/users/avatar-5.jpg" alt="" class="avatar-xs rounded-circle me-1" />
                                ...
                                <td>
                                    16 Apr,24
                                    <small class="text-muted">10:21:25 am</small>
                                </td>
                                <td>
                                    <span class="badge bg-warning-subtle text-warning p-1">Onhold</span>
                                </td>
                            </tr>

                            <tr>
                                <td>
                                    <img src="/images/users/avatar-4.jpg" alt="" class="avatar-xs rounded-circle me-1" />
                                ...
                                <td>
                                    <span class="badge bg-danger-subtle text-danger p-1">Failed</span>
                                </td>
                            </tr>
                        </tbody>
                        <!-- end tbody -->
                    ...
                    <table class="table table-nowrap table-borderless table-sm table-centered mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    48.63%
                                    <span class="badge badge-soft-success ms-1">2.5% Up</span>
                                </td>
                            </tr>
                            <tr>
                                <td>Offline</td>
                                ...
                                <td>
                                    36.08%
                                    <span class="badge badge-soft-success ms-1">8.5% Up</span>
                                </td>
                            </tr>
                            <tr>
                                <td>Direct</td>
                                ...
                                <td>
                                    23.41%
                                    <span class="badge badge-soft-danger ms-1">10.98% Down</span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
