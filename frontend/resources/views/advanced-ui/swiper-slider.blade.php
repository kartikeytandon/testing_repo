@extends('layouts.vertical', ['title' => 'Swiper Slider', 'subTitle' => 'Advanced UI'])
    ...
    <div class="col-xl-9">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="overview">
                    Overview
                    <a class="btn btn-sm btn-outline-success rounded-2 float-end" href="https://swiperjs.com/get-started" target="_blank">
                        Official Website
                    </a>
                </h5>
                <p class="text-muted mb-3">
                    Swiper is the most modern slider with
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    Use
                    <code>data-swiper="navigation"</code>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    Use
                    <code>data-swiper="effect-fade"</code>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    Use
                    <code>data-swiper="creative"</code>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    Use
                    <code>data-swiper="scrollbar"</code>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    Use
                    <code>data-swiper="vertical"</code>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    Use
                    <code>data-swiper="mousewheel"</code>
                    attribute to set a swiper with
                    mousewheel scroll.
                </p>
                <div class="row">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    Use
                    <code>data-swiper="responsive"</code>
