@extends('layouts.vertical', ['title' => 'Placeholders', 'subTitle' => 'Base UI'])
    ...
    <div class="col-xl-9">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    ...
                    <code>.placeholder</code> class and
                    a grid column class (e.g.,
                    <code>.col-6</code>) to set the
                    <code>width</code>. They can replace
                    the text inside an element or be
                    added as a modifier class to an
                    existing component.
                </p>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    You can change the
                    <code>width</code> through grid
                    column classes, width utilities, or
                    inline styles.
                </p>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    By default, the
                    <code>placeholder</code> uses
                    <code>currentColor</code>. This can
                    be overridden with a custom color or
                    utility class.
                </p>
