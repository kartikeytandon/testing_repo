@extends('layouts.vertical', ['title' => 'Pagination', 'subTitle' => 'Base UI'])
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="rounded-pagination">
                    Rounded Pagination
                    <a class="anchor-link" href="#rounded-pagination">#</a>
                </h5>
                <p class="text-muted">
                    Simple pagination inspired by Rdio,
                    great for apps and search results.
                </p>
                <div class="mb-3">
                    <nav aria-label="Page navigation example">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    ...
                    components with flexbox utilitie
                </p>
                <div class="mb-3">
                    <nav aria-label="Page navigation example">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="sizing">
                    Sizing
                    <a class="anchor-link" href="#sizing">#</a>
                </h5>
                <p class="text-muted">
                    Add <code>.pagination-lg</code> or
                    <code>.pagination-sm</code> for
                    additional sizes.
                </p>
