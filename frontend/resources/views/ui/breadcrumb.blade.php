@extends('layouts.vertical', ['title' => 'Breadcrumb', 'subTitle' => 'Base UI'])
    ...
    <div class="col-xl-9">
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    Use an ordered or unordered list with
                    linked list items to create a minimally
                    styled breadcrumb. Use our utilities to
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="dividers_breadcrumb">
                    Dividers Breadcrumb
                    <a class="anchor-link" href="#dividers_breadcrumb">#</a>
                </h5>
                <p class="text-muted">
                    Optionally you can also specify the icon
                    with your breadcrumb item.
                </p>
                <div class="mb-3">
