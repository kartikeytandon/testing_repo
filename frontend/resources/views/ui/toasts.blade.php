@extends('layouts.vertical', ['title' => 'Toasts', 'subTitle' => 'Base UI'])
        ...
        <div class="col-xl-9">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted">
                        Toasts are as flexible as you need and
                        have very little required markup. At a
                        minimum, we require a single element to
                        contain your “toasted” content and
                        strongly encourage a dismiss button.
                    </p>

                    <div class="mb-3">
                        <div class="toast fade d-block opacity-100" role="alert" aria-live="assertive"
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted">
                        ...
                        (positioned with our utilities in the
                        lower right corner) that has been hidden
                        by default.
                    </p>

                    <div class="mb-3">
                        <button type="button" class="btn btn-primary" id="liveToastDefaultBtn">
                            Show live toast
                        </button>

                        <div class="toast-container position-fixed bottom-0 end-0 p-3">
                            <div id="liveToastDefault" class="toast" role="alert" aria-live="assertive"
                                 aria-atomic="true">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted">
                        Toasts are slightly translucent, too, so
                        they blend over whatever they might
                        appear over. For browsers that support
                        the backdrop-filter CSS property, we’ll
                        also attempt to blur the elements under
                        a toast.
                    </p>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted">
                        ...
                        them. The top right is often used for
                        notifications, as is the top middle. If
                        you’re only ever going to show one toast
                        at a time, put the positioning styles
                            ...
                            <div class="my-3">
                                ...
                                <select class="form-select mt-2" data-choices id="selectToastPlacement">
                                    ...
                                    <option value="top-0 start-0">
                                        Top left (<code class="text-danger">.top-0
                                            .start-0</code>)
                                    </option>
...
@endsection
@section('script')
    @vite(['resources/js/components/ui-toasts.js'])
@endsection
