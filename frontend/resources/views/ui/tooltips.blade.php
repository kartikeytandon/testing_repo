@extends('layouts.vertical', ['title' => 'Tooltips', 'subTitle' => 'Base UI'])
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="color_tooltip">
                    Color Tooltip
                    <a class="anchor-link" href="#color_tooltip">#</a>
                </h5>
                <p class="text-muted">
                    We set a custom class with ex.
                    <code>data-bs-custom-class="primary-tooltip"</code>
                    to scope our background-color primary
                    appearance and use it to override a
                    local CSS variable.
                </p>
                <div class="mb-3">
                    <div class="d-flex flex-wrap gap-3">
