@extends('layouts.vertical', ['title' => 'Nav Tabs', 'subTitle' => 'Base UI'])
    ...
    <div class="col-xl-9">
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted mb-3">
                    Use the <code>.nav-tabs</code> class to
                ...
                <div class="tab-content text-muted">
                    ...
                    <div class="tab-pane show active" id="profile">
                        <p class="mb-0">
                            ...
                            litot Europa usa li sam
                            vocabular. Li lingues differe
                            solmen in li grammatica, li
                            pronunciation e li plu commun
                            vocabules. Omnicos directe al
                            desirabilite de un nov lingua
                            franca: On refusa continuar
                            payar custosi traductores. At
                            solmen va esser necessi far
                            uniform grammatica,
                            pronunciation e plu sommun
                            paroles. Ma quande lingues
                            coalesce, li grammatica del
                            resultant lingue es plu simplic
                            e regulari quam ti del
                            coalescent lingues. Li nov
                            lingua franca va esser plu
                            simplic e regulari quam li
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    Using class <code>.nav-justified</code>,
                    you can force your tabs menu items to
                    ...
                    <div class="tab-content pt-2 text-muted">
                        ...
                        <div class="tab-pane show active" id="profileTabsJustified">
                            <p class="mb-0">
                                ...
                                membres del sam familie. Lor
                                separat existentie es un
                                myth. Por scientie, musica,
                                sport etc, litot Europa usa
                                li sam vocabular. Li lingues
                                differe solmen in li
                                grammatica, li pronunciation
                                e li plu commun vocabules.
                                Omnicos directe al
                                desirabilite de un nov
                                lingua franca: On refusa
                                continuar payar custosi
                                traductores. At solmen va
                                esser necessi far uniform
                                grammatica, pronunciation e
                                plu sommun paroles. Ma
                                quande lingues coalesce, li
                                grammatica del resultant
                                lingue es plu simplic e
                                regulari quam ti del
                                coalescent lingues. Li nov
                                lingua franca va esser plu
                                simplic e regulari quam li
                                existent Europan lingues.
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    Use the <code>.nav-pills</code> class to
                    generate a pilled interface.
                </p>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    Using class <code>.nav-justified</code>,
                    you can force your pills menu items to
                    use the full available width.
                </p>
                        ...
                        <div class="tab-content pt-2 text-muted">
                            ...
                            <div class="tab-pane show active" id="profilePillJustified">
                                <p class="mb-0">
                                    ...
                                    es un myth. Por
                                    scientie, musica, sport
                                    etc, litot Europa usa li
                                    sam vocabular. Li
                                    lingues differe solmen
                                    in li grammatica, li
                                    ...
                                    lingua franca: On refusa
                                    continuar payar custosi
                                    traductores. At solmen
                                    va esser necessi far
                                    uniform grammatica,
                                    pronunciation e plu
                                    sommun paroles. Ma
                                    quande lingues coalesce,
                                    li grammatica del
                                    resultant lingue es plu
                                    simplic e regulari quam
                                    ti del coalescent
                                    lingues. Li nov lingua
                                    franca va esser plu
                                    simplic e regulari quam
                                    li existent Europan
                                    lingues.
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    You can stack your navigation by
                    changing the flex item direction with
                    the <code>.flex-column</code> utility.
                </p>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="varying-modal-content">
                    Tabs Vertical Right
                    <a class="anchor-link" href="#varying-modal-content">#</a>
                </h5>
                <p class="text-muted">
                    You can stack your navigation by
                    changing the flex item direction with
