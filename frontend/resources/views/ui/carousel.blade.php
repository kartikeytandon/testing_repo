@extends('layouts.vertical', ['title' => 'Carousel', 'subTitle' => 'Base UI'])
    ...
    <div class="col-xl-9">
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    Here’s a carousel with slides only. Note
                    the presence of the
                    <code>.d-block</code> and
                    <code>.img-fluid</code> on carousel
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="with-controls">
                    With Controls
                    <a class="anchor-link" href="#with-controls">#</a>
                </h5>
                <p class="text-muted">
                    Adding in the previous and next
                    controls:
                </p>
                <div class="row">
                    <div class="col-lg-6">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="with-indicators">
                    With Indicators
                    <a class="anchor-link" href="#with-indicators">#</a>
                </h5>
                <p class="text-muted">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="with-captions">
                    With Captions
                    <a class="anchor-link" href="#with-captions">#</a>
                </h5>
                <p>
                    Add captions to your slides easily with
                    the
                    <code>.carousel-caption</code> element
                    within any <code>.carousel-item</code>.
                    They can be easily hidden on smaller
                    viewports, as shown below, with optional
                    display utilities. We hide them
                    initially with <code>.d-none</code> and
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="crossfade">
                    Crossfade
                    <a class="anchor-link" href="#crossfade">#</a>
                </h5>
                <p class="text-muted">
                    Add <code>.carousel-fade</code> to your
                    ...
                    <code>.bg-body</code> or some custom CSS
                    to the <code>.carousel-item</code>s for
                    proper crossfading.
                </p>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="individual-carousel-item-interval">
                    Individual
                    <code> .carousel-item </code> interval
                    <a class="anchor-link" href="#individual-carousel-item-interval">#</a>
                </h5>
                <p class="text-muted">
                    Add <code>data-bs-interval=""</code> to
                    a <code>.carousel-item</code> to change
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="disable-touch-swiping">
                    ...
                    <code> .carousel-item </code> interval
                    <a class="anchor-link" href="#disable-touch-swiping">#</a>
                </h5>
                <p class="text-muted">
                    ...
                    the <code>data-bs-ride</code> attribute
    ...
    <div class="col-xl-3">
        <div class="card docs-nav">
            <ul class="nav bg-transparent flex-column">
                ...
                <li class="nav-item">
                    <a href="#individual-carousel-item-interval" class="nav-link">Individual .carousel-item
                        interval</a>
                </li>
                <li class="nav-item">
