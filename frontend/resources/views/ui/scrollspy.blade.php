@extends('layouts.vertical', ['title' => 'Scrollspy', 'subTitle' => 'Base UI'])
            ...
            <div class="mb-3">
                ...
                <div class="scrollspy-example bg-light bg-opacity-50 p-3 rounded-2" data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
                    ...
                    <p>
                        ...
                        the scrollspy page. Note that as you
                        scroll down the page, the
                        appropriate navigation link is
                        highlighted. It's repeated
                        throughout the component example. We
                        keep adding some more example copy
                        here to emphasize the scrolling and
                        highlighting.
                    </p>
