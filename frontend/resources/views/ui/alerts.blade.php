@extends('layouts.vertical', ['title' => 'Alerts', 'subTitle' => 'Base UI'])
    ...
    <div class="col-xl-9">
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    ...
                    text, as well as an optional dismiss
                    button.
                </p>
                <div class="mb-3">
                    ...
                    <div class="alert alert-secondary" role="alert">
                        A simple secondary alert—check it
                        out!
                    </div>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="alert-dismissible">
                    ...
                    <a class="anchor-link" href="#alert-dismissible">#</a>
                </h5>
                <p class="text-muted">
                    Add a dismiss button and the
                    <code>.alert-dismissible</code> class,
                    which adds extra padding to the right of
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-muted">
                    Use the <code>.alert-link</code> utility
                    class to quickly provide matching
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="alert-icon">
                    Icons Alert Example
                    <a class="anchor-link" href="#alert-icon">#</a>
                </h5>
                <p class="text-muted">
                    You can also include additional elements
                    like icons, heading, etc along side the
                    actual message.
                </p>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-1 anchor" id="alert-additional">
                    ...
                    <a class="anchor-link" href="#alert-additional">#</a>
                </h5>
                <p class="text-muted">
                    Alerts can also contain additional HTML
                    elements like headings, paragraphs and
                    dividers.
                </p>
                        ...
                        <div class="col-xl-6">
                            <div class="alert alert-primary mb-3 p-3 mb-xl-0" role="alert">
                                ...
                                <p class="mb-0">
                                    ...
                                    see how spacing within
                                    an alert works with this
                                    kind of content.
                                </p>
                                <hr />
                                <p class="mb-0">
