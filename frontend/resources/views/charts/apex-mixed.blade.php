@extends('layouts.vertical', ['title' => 'Apex Mixed Charts', 'subTitle' => 'Charts'])
...
<div class="row">
    <div class="col-xl-9">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-3 anchor" id="line-column">
                    Line & Column Chart
                </h4>
                <div dir="ltr">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-3 anchor" id="multiple-yaxis">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-3 anchor" id="line-area">
                    Line & Area Chart
                </h4>
                <div dir="ltr">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-3 anchor" id="all">
