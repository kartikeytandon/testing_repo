@extends('layouts.vertical', ['title' => 'Apex Area Chart', 'subTitle' => 'Charts'])
...
<div class="row">
    <div class="col-xl-9">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title anchor mb-3" id="basic">
                    Basic Area Chart<a class="anchor-link" href="#basic">#</a>
                </h5>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title anchor mb-3" id="spline">
                    Spline Area<a class="anchor-link" href="#spline">#</a>
                </h5>
            ...
            <div class="card-body">
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3">
                    ...
                    <div class="toolbar apex-toolbar">
                        <button id="one_month" class="btn btn-sm btn-soft-secondary">
                            1M
                        </button>
                        <button id="six_months" class="btn btn-sm btn-soft-secondary">
                            6M
                        </button>
                        <button id="one_year" class="btn btn-sm btn-soft-secondary active">
                            1Y
                        </button>
                        <button id="ytd" class="btn btn-sm btn-soft-secondary">
                            YTD
                        </button>
                        <button id="all" class="btn btn-sm btn-soft-secondary">
                            ALL
                        </button>
                    </div>
                </div>
