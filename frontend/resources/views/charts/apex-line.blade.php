@extends('layouts.vertical', ['title' => 'Apex Line Charts', 'subTitle' => 'Charts'])
...
<div class="row">
    <div class="col-xl-9">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-3 anchor" id="simple">
                    Simple line chart
                </h4>
                <div dir="ltr">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-3 anchor" id="datalabel">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-3 anchor" id="zoomable">
                    Zoomable Timeseries
                </h4>
                <div dir="ltr">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-3 anchor" id="syncing">
                    Syncing charts
                </h4>
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-3 anchor" id="missing">
                    Missing / Null values
                </h4>
                <div dir="ltr">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-3 anchor" id="dashed">
                    Dashed Line Chart
                </h4>
                <div dir="ltr">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-3 anchor" id="stepline">
                    Stepline Chart
                </h4>
                <div dir="ltr">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-3 anchor" id="brush">
                    Brush Chart
                </h4>
                <div dir="ltr">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-3 anchor" id="realtime">
                    Realtime Chart
                </h4>
                <div dir="ltr">
